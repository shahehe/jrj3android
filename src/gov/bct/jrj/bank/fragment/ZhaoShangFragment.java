 ...
 *
 */
public class ZhaoShangFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parentView= inflater.inflate(R.layout.fragment_zhaoshang, container,false);
	...
	private void selectTab(int index) {
		...
		case 0:
			...
			transaction.replace(R.id.fragment_content, introFragment,"zhaoshang");
		...
		case 1:
			...
			transaction.replace(R.id.fragment_content, dynamicFragment,"zhaoshang");
			break;
		}
