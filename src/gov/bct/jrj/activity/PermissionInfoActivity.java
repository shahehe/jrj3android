...
public class PermissionInfoActivity extends Activity {
	...
	private void loadData() {
		String url = Utils.getMetaValue(PermissionInfoActivity.this, "base_url")
				+ "/rest/medicinal2/" + id;
	...
	public void processData(JSONObject json) {
		try {
			...
			Alerts.show(e.getMessage(), PermissionInfoActivity.this);
		}
	}
				...
				public void onSuccess(JSONArray response) {
					try {
						...
						if (md5.equals(dataMd5)) {
							Toast.makeText(PermissionInfoActivity.this, "已经是最新了",
									Toast.LENGTH_SHORT).show();
						} else {
							Toast.makeText(PermissionInfoActivity.this, "图册已经更新",
									Toast.LENGTH_SHORT).show();
							Config.setCacheData(PermissionInfoActivity.this, url,
									json.toString());
							processData(json);
						}
		...
		BctidAPI.get("/rest/medicinal2/" + id, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, JSONArray response) {
				try {
					...
					Config.setCacheData(
							...
							Utils.getMetaValue(PermissionInfoActivity.this,
									"base_url") + "/rest/medicinal2/" + id,
							object.toString());
					processData(object);
				} catch (Exception ex) {
					WizardAlertDialog.showErrorDialog(PermissionInfoActivity.this,
			...
			public void onStart() {
				WizardAlertDialog.getInstance().showProgressDialog(
						R.string.add_data, PermissionInfoActivity.this);
			}
		});
	}
}
