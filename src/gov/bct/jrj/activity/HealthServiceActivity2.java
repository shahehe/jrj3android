 ...
 *
 */
public class HealthServiceActivity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				HealthServiceActivity2.this.finish();
			}
		});
	...
	private void loadData() {
		String url = Utils
				.getMetaValue(HealthServiceActivity2.this, "base_url")
		...
		try {
			...
			if (mAdapter == null) {
				...
				mAdapter = new HealthServiceAdapter2(
						HealthServiceActivity2.this, mListItem);
				listView.setAdapter(mAdapter);
			}
		} catch (JSONException e) {
			Alerts.show(e.getMessage(), HealthServiceActivity2.this);
		}
	}
				...
				public void onSuccess(JSONArray response) {
					try {
						...
						if (md5.equals(dataMd5)) {
							Toast.makeText(HealthServiceActivity2.this,
									"已经是最新了", Toast.LENGTH_SHORT).show();
						} else {
							Toast.makeText(HealthServiceActivity2.this,
									"图册已经更新", Toast.LENGTH_SHORT).show();
							Config.setCacheData(HealthServiceActivity2.this,
									url, json.toString());
							processData(json);
						}
		...
		BctidAPI.get("/rest/article-list/" + id, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, JSONArray response) {
				try {
					...
					Config.setCacheData(
							HealthServiceActivity2.this,
							Utils.getMetaValue(HealthServiceActivity2.this,
									"base_url") + "/rest/article-list/" + id,
							object.toString());
					processData(object);
				} catch (Exception ex) {
					WizardAlertDialog.showErrorDialog(
							HealthServiceActivity2.this, ex.getMessage(),
							R.string.btn_ok);
				}
			}
			...
			public void onFailure(Throwable e, JSONArray errorResponse) {
				WizardAlertDialog.showErrorDialog(HealthServiceActivity2.this,
			...
			public void onStart() {
				WizardAlertDialog.getInstance().showProgressDialog(
						R.string.add_data, HealthServiceActivity2.this);
			}
		});
	}
}
