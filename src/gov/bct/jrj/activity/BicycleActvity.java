 ...
 * 公租自行车 演示覆盖物的用法
 */
public class BicycleActvity extends Activity {
	...
	private TextView zuijin;// 展示最近网点

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bicycle);
		BaiduNaviManager.getInstance().initEngine(BicycleActvity.this,
	...
	private void loadData() {
		String url = Utils.getMetaValue(BicycleActvity.this, "base_url")
				+ "/rest/bike";
		// 读取缓存
		String data = Config.getCacheData(BicycleActvity.this, url);
		if (data == null) {
			// 读取本地
	...
	public void processData(JSONObject json) {
		try {
			...
			zuijin.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					getNearbyPoint(mList);
				}
			});

		} catch (JSONException e) {
			Alerts.show(e.getMessage(), BicycleActvity.this);
		}
	}
	...
	public void checkUpdate(final String url, final String data) {
		if (Config.isConnected(BicycleActvity.this)) {
				...
				public void onSuccess(JSONArray response) {
					try {
						...
						if (md5.equals(dataMd5)) {
							Toast.makeText(BicycleActvity.this, "已经是最新了",
									Toast.LENGTH_SHORT).show();
						} else {
							Toast.makeText(BicycleActvity.this, "数据已经更新",
									Toast.LENGTH_SHORT).show();
							Config.setCacheData(BicycleActvity.this, url,
									json.toString());
							processData(json);
						}
		...
		BctidAPI.get("/rest/bike", new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, JSONArray response) {
				try {
					...
					Config.setCacheData(BicycleActvity.this,
							Utils.getMetaValue(BicycleActvity.this, "base_url")
									+ "/rest/bike", object.toString());
					processData(object);
				} catch (Exception ex) {
					WizardAlertDialog.showErrorDialog(BicycleActvity.this,
			...
			public void onStart() {
				WizardAlertDialog.getInstance().showProgressDialog(
						R.string.add_data, BicycleActvity.this);
			}
		});
	}
	...
	public void initOverlay(final List<Bicycle> list) {
		...
		mBaiduMap.setOnMarkerClickListener(new OnMarkerClickListener() {
			...
			public boolean onMarkerClick(Marker arg0) {
				...
				View infoWindowView = LayoutInflater.from(BicycleActvity.this)
		...
		BaiduNaviManager.getInstance().launchNavigator(this, startPoint, // 起点（可指定坐标系）
				...
				new OnStartNavigationListener() { // 跳转监听
					...
					public void onJumpToNavigator(Bundle configParams) {
						Intent intent = new Intent(BicycleActvity.this,
	...
	public void initLocation() {
		mLocClient = new LocationClient(BicycleActvity.this);
