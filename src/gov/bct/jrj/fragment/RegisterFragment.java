...
public class RegisterFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Button registerBtn = (Button) view.findViewById(R.id.button1);
	...
	class RegisterOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			if (TextUtils.isEmpty(userEdit.getText())) {
				...
				// Toast.makeText(mContext, "电子邮件不能为空",
				...
				SharedPreferences mPrefs = mContext.getSharedPreferences(
						PushService.TAG, Context.MODE_PRIVATE);
				String deviceID = mPrefs.getString(PushService.PREF_DEVICE_ID,
						null);
				...
				if (Config.isConnected(RegisterFragment.this.getActivity())) {
					...
					client.post(Config.URL + "/register.php", params,
										...
										if (response.getInt("code") == 1) {
											...
											Toast.makeText(
													RegisterFragment.this
															.getActivity(),
													"注册成功！感谢您的注册，我们会妥善保管您的个人信息，并会在有需要的时候和您取得联系。",
													Toast.LENGTH_SHORT).show();

											SharedPreferences prefs = mContext
													.getSharedPreferences(
															Constants.KEY_SESSION_PREFS,
															0);
											...
											editor.putString(
													...
													userEdit.getText()
															.toString());
											editor.putBoolean(
													Constants.KEY_IS_LOGINED,
													true);
											editor.putInt(Constants.KEY_UID,
													response.getInt("uid"));
											editor.commit();
											SharedPreferences autoPrefs = mContext
													.getSharedPreferences(
															PushService.TAG,
															android.content.Context.MODE_PRIVATE);
											Editor editorAuto = autoPrefs
													.edit();
											editorAuto.putBoolean("isAutoPush",
													true);
											editorAuto.commit();
											Utils.sendMessage(
													Session.getInstance()
															.getHandler(),
													Constants.WHAT_LOGIN);
										} else {
//											Toast.makeText(
//													RegisterFragment.this
//															.getActivity(),
...
//													Toast.LENGTH_SHORT).show();
								...
								public void onFinish() {
									// Toast.makeText(RegisterFragment.this.getActivity(),
									// "return code error 222",
									// Toast.LENGTH_SHORT).show();
									pd.dismiss();
								}
								...
								public void onFailure(Throwable error) {
									// Toast.makeText(RegisterFragment.this.getActivity(),
									// "return code error 333",
									// Toast.LENGTH_SHORT).show();
									Alerts.show(error.getMessage(),
											RegisterFragment.this.getActivity());
									pd.dismiss();
								}
