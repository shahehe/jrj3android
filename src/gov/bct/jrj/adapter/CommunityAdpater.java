 ...
 * 便民商铺Adapter
 */
public class CommunityAdpater extends BaseAdapter {
	Context context;
	List<Shop> items;
	
	public CommunityAdpater(Context context,List<Shop> items){
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView==null){
			convertView = View.inflate(context, R.layout.community_list_item,null);
